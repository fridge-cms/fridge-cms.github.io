...
<Code name="content.create" version="v2" />
...
<Params>
  ...
  <Param name=":identifier" required>
    The id or slug of the content type used to create the content item. The name
    of the content type.
  </Param>
  <Param
    name="active"
  ...
  <Param name="slug">
    A unique slug identifier for the content item. One will be intelligently
    generated for you if not specified.
  </Param>
...
<Code name="content.get" version="v2" />
...
<Code name="content.update" version="v2" />
...
<Code name="content.delete" version="v2" />
...
<Code name="content.list" version="v2" />
...
<Params>
  ...
  <Param name="type">The id or slug of a content type to filter by.</Param>
  <Param name="active">
    <code>true</code> or <code>false</code> or <code>all</code>. Filters content
    by active, inactive, or both.
  </Param>
  <Param name="limit">
  ...
  <Param
    ...
    extra={
      <span>
        default is <code>date_created</code> or the sort method of the content
        type
      </span>
    }
  >
    Specify how content is sorted. Options are <code>date_created</code>,{" "}
    <code>manual</code>, <code>hierarchy</code>, or any valid part name.
  </Param>
  <Param name="sort_order">
    Specify the direction of the sort. <code>asc</code> or <code>desc</code>
  </Param>
  <Param name="{part_name}">Any part name/part value pair to filter by.</Param>
</Params>
...
<Code name="content.upload" version="v2" />
...
<Code name="content.file" version="v2" />
...
<Code name="content.public" version="v2" />
