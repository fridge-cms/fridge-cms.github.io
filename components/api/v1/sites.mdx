...
<Code name="site.create" version="v1" />
...
<Params>
  ...
  <Param name="webhooks">
    An array of URLs that will be sent a <code>POST</code> request upon site
    actions.
  </Param>
...
<Code name="site.update" version="v1" />
...
<Code name="site.delete" version="v1" />

Permanently deletes a site. It cannot be undone.

<p className="warning">
  All content, settings, and users belonging to the specified site are also
  permanently deleted.
</p>
...
<Code name="site.list" version="v1" />
...
<Code name="site.keys" version="v1" />
